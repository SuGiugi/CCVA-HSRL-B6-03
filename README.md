...
## Hệ thống cảm biến
- Hai laser sensor V2 (Matrix Laser Sensor V2)  
- Color senser V3  (Matrix Color Sensor V3)
- M-vision camera (M-Vision Cam) 
- Động cơ DC (Main Drive Motor - Kèm Encoder) 
- Động cơ Servo (Micro Servo MG90S) 
## 🚗 Chức năng chính
